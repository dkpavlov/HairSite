...
<div class="header">
    <h1>Галерия</h1>
    <h2>Всички галерии</h2>
</div>

<div class="content">
    <br/><br/>
    <a class="pure-button pure-button-primary" href="${pageContext.request.contextPath}/admin/gallery/new">Нов галерия</a>
    <br/><br/>
    ...
    <script>
        $(document).ready(function() {
            $('.delete').click(function(){
                ...
                $.ajax({
                    url: '${pageContext.request.contextPath}/admin/gallery/'+contactId+'/status',
                    type: 'PUT',
