...
<div class="content">
    <br/><br/>
    <a class="pure-button pure-button-primary" href="${pageContext.request.contextPath}/admin/salon/new">Нов салон</a>
    <br/><br/>
    ...
    <script>
        $(document).ready(function() {
            $('.delete').click(function(){
                ...
                $.ajax({
                    url: '${pageContext.request.contextPath}/admin/salon/'+contactId+'/status',
                    type: 'PUT',
