...
<div class="header">
    <h1>Новини</h1>
    <c:if test="${not empty serviceItem.id}">
        <h2>Редактиране на ${serviceItem.name}</h2>
    </c:if>
    <c:if test="${empty serviceItem.id}">
        <h2>Нова системна услуги</h2>
    </c:if>
</div>
<br/>
<div class="content">
    <form:form modelAttribute="serviceItem" class="pure-form pure-form-aligned">
        <fieldset>
